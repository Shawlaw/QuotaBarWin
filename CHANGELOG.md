...
- 发现更新后，主窗口和托盘小窗都会显示更新提示。

### Changed

- 更新提示提供“前往更新”和“稍后”；“前往更新”会直接打开并定位到设置中的“应用更新”，“稍后”关闭当前版本的提示。
- 下载并重启更新会使用提示中已经验证的版本。
- 概览和设置会分别保留各自的滚动位置。

### Fixed

- 修复从托盘小窗“前往更新”时，已打开或恢复的主窗口可能无响应的问题。
- 修复重新打开设置页时可能重复定位到“应用更新”区的问题。
